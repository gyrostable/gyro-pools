...
def calculateQuadraticTerms(balances: Iterable[D], sqrtAlpha: D, sqrtBeta: D) -> tuple[D, D, D]:
    x, y = balances
...
def liquidityInvariantUpdate(balances: Iterable[D], sqrtAlpha: D, sqrtBeta: D, lastInvariant: D, diffY: D, isIncreaseLiq: bool) -> D:
    x, y = balances
...
def calcOutGivenIn(balanceIn: D, balanceOut: D, amountIn: D, virtualParamIn: D, virtualParamOut: D, currentInvariant: D) -> D:
...
def calcInGivenOut(balanceIn: D, balanceOut: D, amountOut: D, virtualParamIn: D, virtualParamOut: D, currentInvariant: D) -> D:
...
def calcAllTokensInGivenExactBptOut(balances: Iterable[D], bptAmountOut: D, totalBPT: D) -> tuple[D, D]:
    bptRatio = bptAmountOut / totalBPT
    x, y = balances
    return x * bptRatio, y * bptRatio


def calcTokensOutGivenExactBptIn(balances: Iterable[D], bptAmountIn: D, totalBPT: D) -> tuple[D, D]:
    bptRatio = bptAmountIn / totalBPT
    x, y = balances
    return x * bptRatio, y * bptRatio


def calcDueTokenProtocolSwapFeeAmount(balances: Iterable[D], previousInvariant: D, currentInvariant: D, protocolSwapFeePercentage: D, sqrtParams: Iterable[D]) -> tuple[D, D]:
