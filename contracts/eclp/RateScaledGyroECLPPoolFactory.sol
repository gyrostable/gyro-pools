...
import "../../interfaces/IRateScaledGyroECLPPoolFactory.sol";
import "../../interfaces/ICappedLiquidity.sol";
import "./RateScaledGyroECLPPool.sol";

contract RateScaledGyroECLPPoolFactory is IRateScaledGyroECLPPoolFactory, BasePoolSplitCodeFactory, FactoryWidePauseWindow {
    ...
    function create(
        ...
        return _create(abi.encode(params, gyroConfigAddress, rateProviders[0], rateProviders[1]));
    }
